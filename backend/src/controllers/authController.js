...
exports.registerUser = async (req, res) => {
  ...
  const { firstName, lastName, email, password, role, securityQuestions, lastFourSSN } = req.body;

  try {
    const user = new User({ firstName, lastName, email, password, role, securityQuestions, lastFourSSN });
